...
class AppColor {
  ...
  static const Color gray800 = Color(0xffeeeeee);
  static const Color green = Colors.green;
  static const Color primaryColor = Color(0xff0065E9);
  static const Color secondColor = Color(0xffd8dbef);
  static const Color secondTextColor = Color(0xff263238);
  static const Color grayTextColor = Color(0xff9ea2aa);
  ...
  static const bg = Color(0xff631172);
  ...
  static const aBlue = Color.fromRGBO(30, 60, 168, 1);
